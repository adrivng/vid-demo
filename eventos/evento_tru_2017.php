...
<div id="carouseleventotru2017" class="carousel slide ev-carousel" data-bs-ride="carousel">
    <div class="carousel-indicators">
        <button type="button" data-bs-target="#carouseleventotru2017" data-bs-slide-to="0" class="active"></button>
        <button type="button" data-bs-target="#carouseleventotru2017" data-bs-slide-to="1"></button>
        <button type="button" data-bs-target="#carouseleventotru2017" data-bs-slide-to="2"></button>
        <button type="button" data-bs-target="#carouseleventotru2017" data-bs-slide-to="3"></button>
        <button type="button" data-bs-target="#carouseleventotru2017" data-bs-slide-to="4"></button>
        <button type="button" data-bs-target="#carouseleventotru2017" data-bs-slide-to="5"></button>
    </div>
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/evento_tru_2017/foto01.jpg" class="d-block w-100" alt="Slide 1" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/evento_tru_2017/foto02.jpg" class="d-block w-100" alt="Slide 2" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/evento_tru_2017/foto03.jpg" class="d-block w-100" alt="Slide 3" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/evento_tru_2017/foto04.jpg" class="d-block w-100" alt="Slide 4" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/evento_tru_2017/foto05.jpg" class="d-block w-100" alt="Slide 5" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/evento_tru_2017/foto06.jpg" class="d-block w-100" alt="Slide 6" loading="lazy">
        </div>
    </div>
    <button class="carousel-control-prev" type="button" data-bs-target="#carouseleventotru2017" data-bs-slide="prev">
        <span class="carousel-control-prev-icon btn bg-primary"></span>
        <span class="visually-hidden">Anterior</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouseleventotru2017" data-bs-slide="next">
