<?php
$pageTitle  = 'VIAJE CAPACITACIÓN A CANCÚN 2017';
$activePage = 'eventos';
$subir = '../';
...
<div class="ev-page-header">
    <h1>VIAJE CAPACITACIÓN A CANCÚN 2017</h1>
    <a href="../eventos.php" class="ev-back-btn">&larr; Volver a Eventos</a>
</div>

<div id="carouselfamcancun" class="carousel slide ev-carousel" data-bs-ride="carousel">
    <div class="carousel-indicators">
        <button type="button" data-bs-target="#carouselfamcancun" data-bs-slide-to="0" class="active"></button>
        <button type="button" data-bs-target="#carouselfamcancun" data-bs-slide-to="1"></button>
        <button type="button" data-bs-target="#carouselfamcancun" data-bs-slide-to="2"></button>
        <button type="button" data-bs-target="#carouselfamcancun" data-bs-slide-to="3"></button>
        <button type="button" data-bs-target="#carouselfamcancun" data-bs-slide-to="4"></button>
        <button type="button" data-bs-target="#carouselfamcancun" data-bs-slide-to="5"></button>
    </div>
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/fam_cancun/foto01.jpg" class="d-block w-100" alt="Slide 1" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/fam_cancun/foto02.jpg" class="d-block w-100" alt="Slide 2" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/fam_cancun/foto03.jpg" class="d-block w-100" alt="Slide 3" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/fam_cancun/foto04.jpg" class="d-block w-100" alt="Slide 4" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/fam_cancun/foto05.jpg" class="d-block w-100" alt="Slide 5" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/fam_cancun/foto06.jpg" class="d-block w-100" alt="Slide 6" loading="lazy">
        </div>
    </div>
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselfamcancun" data-bs-slide="prev">
        <span class="carousel-control-prev-icon btn bg-primary"></span>
        <span class="visually-hidden">Anterior</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselfamcancun" data-bs-slide="next">
