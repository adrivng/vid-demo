<?php
$pageTitle  = 'PRESENTACIÓN DE CARIBE Y USA';
$activePage = 'eventos';
$subir = '../';
...
<div class="ev-page-header">
    <h1>PRESENTACIÓN DE CARIBE Y USA</h1>
    <a href="../eventos.php" class="ev-back-btn">&larr; Volver a Eventos</a>
</div>

<div id="carouselcaribeusa" class="carousel slide ev-carousel" data-bs-ride="carousel">
    <div class="carousel-indicators">
        <button type="button" data-bs-target="#carouselcaribeusa" data-bs-slide-to="0" class="active"></button>
        <button type="button" data-bs-target="#carouselcaribeusa" data-bs-slide-to="1"></button>
        <button type="button" data-bs-target="#carouselcaribeusa" data-bs-slide-to="2"></button>
        <button type="button" data-bs-target="#carouselcaribeusa" data-bs-slide-to="3"></button>
        <button type="button" data-bs-target="#carouselcaribeusa" data-bs-slide-to="4"></button>
        <button type="button" data-bs-target="#carouselcaribeusa" data-bs-slide-to="5"></button>
    </div>
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/caribe_usa/foto13.jpg" class="d-block w-100" alt="Slide 1" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/caribe_usa/foto14.jpg" class="d-block w-100" alt="Slide 2" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/caribe_usa/foto15.jpg" class="d-block w-100" alt="Slide 3" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/caribe_usa/foto16.jpg" class="d-block w-100" alt="Slide 4" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/caribe_usa/foto17.jpg" class="d-block w-100" alt="Slide 5" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/caribe_usa/foto18.jpg" class="d-block w-100" alt="Slide 6" loading="lazy">
        </div>
    </div>
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselcaribeusa" data-bs-slide="prev">
        <span class="carousel-control-prev-icon btn bg-primary"></span>
        <span class="visually-hidden">Anterior</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselcaribeusa" data-bs-slide="next">
