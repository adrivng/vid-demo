...
<div id="carouselcasaesperanzacasaplayalima" class="carousel slide ev-carousel" data-bs-ride="carousel">
    <div class="carousel-indicators">
        <button type="button" data-bs-target="#carouselcasaesperanzacasaplayalima" data-bs-slide-to="0" class="active"></button>
        <button type="button" data-bs-target="#carouselcasaesperanzacasaplayalima" data-bs-slide-to="1"></button>
        <button type="button" data-bs-target="#carouselcasaesperanzacasaplayalima" data-bs-slide-to="2"></button>
        <button type="button" data-bs-target="#carouselcasaesperanzacasaplayalima" data-bs-slide-to="3"></button>
        <button type="button" data-bs-target="#carouselcasaesperanzacasaplayalima" data-bs-slide-to="4"></button>
    </div>
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/CASA_PLAYA_LIMA_CASA_ESPERANZA/esperanza_01.jpg" class="d-block w-100" alt="Slide 1" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/CASA_PLAYA_LIMA_CASA_ESPERANZA/esperanza_02.jpg" class="d-block w-100" alt="Slide 2" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/CASA_PLAYA_LIMA_CASA_ESPERANZA/esperanza_03.jpg" class="d-block w-100" alt="Slide 3" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/CASA_PLAYA_LIMA_CASA_ESPERANZA/esperanza_04.jpg" class="d-block w-100" alt="Slide 4" loading="lazy">
        </div>
        <div class="carousel-item">
            <img src="images/CASA_PLAYA_LIMA_CASA_ESPERANZA/esperanza_05.jpg" class="d-block w-100" alt="Slide 5" loading="lazy">
        </div>
    </div>
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselcasaesperanzacasaplayalima" data-bs-slide="prev">
        <span class="carousel-control-prev-icon btn bg-primary"></span>
        <span class="visually-hidden">Anterior</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselcasaesperanzacasaplayalima" data-bs-slide="next">
