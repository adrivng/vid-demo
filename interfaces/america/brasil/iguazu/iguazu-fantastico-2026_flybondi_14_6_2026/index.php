...
// ── Rutas absolutas al filesystem ──────────────────────────────────────────
$base = rtrim($_SERVER['DOCUMENT_ROOT'], '/') . '/vid-demo/';

// ── URL base dinámica (funciona en localhost Y en cPanel sin cambios) ───────
$protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
$host     = $_SERVER['HTTP_HOST'];                        // localhost o tudominio.com
$baseUrl  = $protocol . '://' . $host . '/vid-demo/';    // http://localhost/vid-demo/
