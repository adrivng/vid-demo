...
$pageTitle  = 'Punta Cana Semana Santa 2026';
$activePage = '';
...
<!-- HERO -->
<div class="prog-hero" style="background-image:url('img/punta-cana-semana-santa-2026_latam_31_5_2026_pr.jpg')">
    <div class="prog-hero__overlay"></div>
    <div class="prog-hero__content">
        <span class="prog-hero__tipo">CON AEREO</span>
        <h1 class="prog-hero__title">Punta Cana Semana Santa 2026</h1>
...
<div class="container py-5">
    <div class="prog-layout">
        ...
        <aside class="prog-sidebar">
            <div class="prog-card">
                ...
                <ul class="prog-card__meta">
                    <?php if ('8 Días - 7 Días' !== ''): ?>
                    <li><i class="fa fa-clock"></i> 8 Días - 7 Días</li>
                    <?php endif; ?>
                    <?php if ('LATAM' !== ''): ?>
                ...
                <?php if ('word_punta-cana-semana-santa-2026_latam_31_5_2026.docx' !== ''): ?>
                <a class="prog-card__btn-word" href="word_punta-cana-semana-santa-2026_latam_31_5_2026.docx" target="_blank">
                    <i class="fa fa-file-word"></i> Descargar programa
                </a>
                <?php endif; ?>

                <button class="prog-card__btn-wa" onclick="openWA('Punta Cana Semana Santa 2026')">
        ...
        <div class="prog-main">
            <?php if ('punta-cana-semana-santa-2026_latam_31_5_2026_in.jpg' !== ''): ?>
            <img class="prog-img-in img-fluid rounded-3 mb-4"
                 src="img/punta-cana-semana-santa-2026_latam_31_5_2026_in.jpg"
                 alt="Punta Cana Semana Santa 2026">
            <?php endif; ?>
        </div><!-- /prog-main -->
    </div><!-- /prog-layout -->
</div><!-- /container -->

<?php if ('punta-cana-semana-santa-2026_latam_31_5_2026_cn.jpg' !== ''): ?>
<div class="container pb-5">
    <img class="img-fluid rounded-3"
         src="img/punta-cana-semana-santa-2026_latam_31_5_2026_cn.jpg"
         alt="Punta Cana Semana Santa 2026">
</div>
<?php endif; ?>
