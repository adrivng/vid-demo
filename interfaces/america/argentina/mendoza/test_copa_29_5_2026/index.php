...
// $base apunta siempre a la raíz de vid-demo/ sin importar
// cuán profundo esté este index.php en la jerarquía de carpetas
...
<!-- HERO -->
<div class="prog-hero" style="background-image:url('img/test_copa_29_5_2026_pr.jpg')">
...
<div class="container py-5">
    <div class="prog-layout">
        ...
        <div class="prog-main">
            <?php if ('test_copa_29_5_2026_in.jpg' !== ''): ?>
            <img class="prog-img-in img-fluid rounded-3 mb-4"
                 src="img/test_copa_29_5_2026_in.jpg"
                 alt="TEST">
            <?php endif; ?>
        </div>
        ...
        <aside class="prog-sidebar">
            <div class="prog-card">
                ...
                <ul class="prog-card__meta">
                    ...
                    <?php endif; ?>
                    <?php if ('COPA' !== ''): ?>
                    <li><i class="fa fa-plane"></i> COPA</li>
                    <?php endif; ?>
                    <?php if ('20 Mar. 2026' !== ''): ?>
                ...
                <?php if ('word_test_copa_29_5_2026.docx' !== ''): ?>
                <a class="prog-card__btn-word"
                   href="word_test_copa_29_5_2026.docx"
                   target="_blank">
...
<?php if ('test_copa_29_5_2026_cn.jpg' !== ''): ?>
<div class="container pb-5">
    <img class="img-fluid rounded-3"
         src="img/test_copa_29_5_2026_cn.jpg"
         alt="Newsletter TEST">
</div>
<?php endif; ?>
