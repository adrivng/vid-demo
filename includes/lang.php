 ...
 *         $lang = 'en';
 *
 *  2. Agregá las claves que necesites en $t['en'] (más abajo).
 *
 ...
 *
 *  El array $t['es'] es el fallback — si una clave no existe
 *  en $t['en'], se muestra el valor en español.
 * ============================================================
 */
...
$t = [
  ...
  'es' => [
    ...
    'footer_salidas'    => 'Salidas Confirmadas',
    ...
    // Index — beneficios
    'beneficios_title'  => 'Beneficios Exclusivos',
    ...
    // Breadcrumb en páginas que usen header.php
    'breadcrumb_prev'   => 'Anterior',
    'breadcrumb_next'   => 'Siguiente',
  ],
  ...
  'en' => [
    ...
    // Breadcrumb
    'breadcrumb_prev'   => 'Previous',
    'breadcrumb_next'   => 'Next',
  ],
];
 ...
 * Si la clave no existe en el array, muestra la clave misma.
 */
