...
<div class="container-fluid bg-primary px-5 d-none d-lg-block">
    <div class="row gx-0">
        ...
        <div class="col-lg-4 text-center text-lg-end">
            <div class="d-inline-flex align-items-center topbar-height">
                <a href="#"><small class="me-3 text-light"><i class="fa fa-users me-2"></i><?= __('top_afiliate') ?></small></a>
                <a href="#"><small class="text-light"><i class="fa fa-sign-in-alt me-2"></i><?= __('top_club_vidatur') ?></small></a>
...
<div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary px-4 px-lg-5 py-3 py-lg-0">
        <a href="<?= $subir ?>index.php" class="navbar-brand p-0">
            <h1 class="m-0"><img src="<?= $subir ?>img/images-index/logo.svg" alt="Vidatur Mayorista de Viajes" height="90"></h1>
        </a>
