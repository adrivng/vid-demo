                    ...
                    <div class="search-wrapper position-relative">
                        <div class="row align-items-center g-3">
                            <div class="col-12 col-md-9 position-relative">
                                ...
                                <div id="resultadosBusqueda" class="search-dropdown d-none">
                                    <!-- Los resultados se cargan aquí via JS -->
                                </div>
                            </div>
            ...
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(img/about-img-1.png);">
                        ...
                        <h1 class="mb-4">Agencia Mayorista +25 años <!-- <span class="text-primary">Vidatur</span>--> </h1>
                        ...
                        <div class="row gy-2 gx-4 mb-4">
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Cotizador Online 2.0</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Videos Promocionales Exclusivos</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Paquetes Nacionales</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Paquetes Internacionales</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Socios Estrategicos</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Equipo Vidatur</p>
                            </div>
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Cuentas Bancarias</p>
                            </div>
                            <div class="col-sm-6">
...
<div class="container-fluid bg-light service py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h1 class="section-title px-3">Nuestras Fortalezas</h5>
            <hr>

            <h2 class="mb-0">Representaciones</h1>
        </div>
            
        <!-- GALERIA DE REPRESENTACIONES - Cards Grandes -->
        <!-- GALERIA DE REPRESENTACIONES - Cards Grandes con Link -->
        <div class="container-fluid bg-light pb-5">
            <div class="container">
                <div class="row justify-content-center g-4">
                    
                    <!-- Card 1: United Parks & Resorts -->
                    <div class="col-12 col-sm-6 col-lg-5">
                        <a href="https://sw.vidatur.net/" target="_blank" class="text-decoration-none">
                            <div class="representacion-card bg-white rounded-4 shadow-sm p-5 text-center h-100 d-flex flex-column justify-content-center align-items-center" style="border: none; min-height: 200px;">
                                <img src="img/images-index/united_parks_resorts.png" 
                                    alt="United Parks & Resorts" 
                                    class="img-fluid" 
        ...
        <!-- GALERIA DE REPRESENTACIONES END -->

        <!-- ========== SECCION 1: PARQUES DE SEAWORLD ========== -->
        <div class="mb-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                        ...
                        <div class="service-icon p-4">
                            <i class="fa fa-hippo fa-4x text-primary"></i>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                        <div class="service-icon p-4">
                            <i class="fa fa-fish fa-4x text-primary"></i>
                        </div>
                        <div class="service-content">
        ...
        <div class="mb-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                        <div class="service-icon p-4">
                            <i class="fa fa-parachute-box fa-4x text-primary"></i>
                        </div>
                        <div class="service-content">
                ...
                <div class="col-lg-6">
                    <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                        ...
                        <div class="service-icon p-4">
                            <i class="fa fa-mask fa-4x text-primary"></i>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 ps-0">
                        <div class="service-icon p-4">
                            <i class="fa fa-swimmer fa-4x text-primary"></i>
                        </div>
                        <div class="service-content">
        ...
        <!-- ========== SECCION 3: ALIADOS - CARRUSEL INFINITO ========== -->
        <div class="mb-5">
            <div class="text-center mb-4">
