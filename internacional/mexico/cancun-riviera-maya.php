<?php
$subir = '../../';
$pageTitle = 'Cancún, Riviera Maya y Playa del Carmen - México';
...
<div class="container-fluid bg-breadcrumb bg-breadcrumb--internacional">
    <div class="container text-center py-5 text-max-900">
        <h3 class="text-white display-3 mb-4">México</h3>
    </div>
</div>
...
<div class="container intl-ciudad">
    ...
    <h1 class="intl-ciudad__title">Cancún, Riviera Maya y Playa del Carmen, México</h1>
    <p class="intl-ciudad__subtitle">Encuentra los mejores paquetes y programas para tu viaje</p>

        <?php
        $paisSlug   = 'mexico';
        $ciudadSlug = 'cancun-riviera-maya';
